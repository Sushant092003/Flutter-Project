...
import 'package:splashscreen/bot.dart';
    ...
    return Scaffold(
      appBar: AppBar(
        actions: <Widget>[
          IconButton(
            onPressed: () {
              Navigator.of(context).push(MaterialPageRoute(builder: (context) => BotPage(model: GenerativeModel(model: 'gemini-pro', apiKey: GEMINI_API_KEY))));
            },
